...
| key                  | value                                                                                                                                                               |
|:---------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Programming Language | JavaScript(TypeScript/React.js/Next.js/Node.js), Golang(gRPC/Gin), Erlang/Elixir(Phoenix), PHP(Laravel), Rust(Active Web), SQL/NoSQL, GraphQL, HTML/CSS, and so on. |
| OS                   | Linux (Ubuntu, Redhat), macOS, Windows                                                                                                                              |
| Database             | MySQL, PostgreSQL, Redis, Elasticsearch                                                                                                                             |
| Middleware           | Nginx, RabbitMQ, ElasticSearch, Auth0                                                                                                                               |
...
**ポジション**
- フロント/バックエンド開発エンジニア
  - 金融システムのバッチ開発(Haskell)
  - 位置情報システムの構築(Elixir)
- ネイティブアプリ開発エンジニア
  - ECサイトの開発(Android/Java, iOS/Swift)
- プロジェクトリーダー
  - 自社サービスの
  - ドローンの撮影サービス開発を主導
